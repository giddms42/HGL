		...
		<div id="cover">
			...
			<br>
					...
					<table>
						<col width="624px">
						<col width="624px">
						<tr onclick="javascript:opener.location.href='AdminSearchGG.do';self.close();" id="cursor">
							<td class="div2" id="ans">좋은글 게시판 작성글 갯수</td>
							<td class="div1" id="res">3</td>
						</tr>
						<tr onclick="javascript:opener.location.href='AdminSearchFWLB.do';self.close();" id="cursor">
