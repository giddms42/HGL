				...
				<form action="" id="form2">
					...
					<c:if test="${!empty dto2}">
						<table border="1" bordercolor="white">
							...
							<col width="155">
							<tr>
								<td colspan="3"><div>댓글 목록</div></td>
							</tr>
							<c:forEach items="${dto2 }" var="ggcmDto">
								<tr>
									<td>${ggcmDto.ggcmWriter }</td>
									<td><textarea rows="2" cols="" readonly="readonly" style="resize: none;">${ggcmDto.ggcmCont }</textarea></td>
									<td>
								...
								<tr>
									<td><div>작성일</div></td>
									<td colspan="2"><div><fmt:formatDate value="${ggcmDto.ggcmDate}" pattern="yyyy-MM-dd" /></div></td>
								</tr>
							</c:forEach>
						</table>
					</c:if>
