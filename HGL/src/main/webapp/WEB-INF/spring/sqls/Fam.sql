...
INSERT INTO HEALTH VALUES(5, 100, 100, 80, SYSDATE);
INSERT INTO HEALTH VALUES(5, 50, 70, 100, SYSDATE);
...
FROM(SELECT * FROM HEALTH WHERE FAMNO=5 ORDER BY HEALTHDATE DESC) A ) B
WHERE B.FAMNO=5 
