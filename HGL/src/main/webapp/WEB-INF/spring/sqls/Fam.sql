...
INSERT INTO FAM VALUES(1, FAMNO_SEQ.NEXTVAL, '엄마', '160', '당뇨병', '지방간', '빈혈', '19620220', '음력');
...
INSERT INTO HEALTH VALUES(1, 120, 80, 60, SYSDATE);

DELETE FROM HEALTH WHERE FAMNO=5; AND ROWNUM=2;
...
SELECT * FROM (
SELECT *
FROM( SELECT * FROM HEALTH WHERE FAMNO=5)
