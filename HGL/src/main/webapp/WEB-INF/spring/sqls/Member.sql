...
SELECT * FROM MEMBER where MEMBERNICKNAME='ww';

UPDATE MEMBER SET MEMBERPROHIBITTIME=TO_DATE('2018-06-22 16:11:40','yyyy-mm-dd hh24:mi:ss') WHERE MEMBERNICKNAME='ww' 

UPDATE MEMBER SET MEMBERPROHIBITCOUNT=3 where memberId='testing1'

UPDATE MEMBER SET MEMBERSMS='Y' where memberId='testing1'
