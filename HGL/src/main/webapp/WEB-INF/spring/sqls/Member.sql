...
UPDATE MEMBER SET MEMBERPROHIBITCOUNT=1 WHERE MEMBERNICKNAME='쥐쥐'

UPDATE MEMBER SET MEMBERPROHIBITTIME=to_date('2018-06-15-11-03-00', 'yyyy-mm-dd-hh24-mi-ss') WHERE MEMBERNICKNAME='흠'
